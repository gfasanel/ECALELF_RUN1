...
public:
  ...
  inline  void SetInitFileMC(TString initFileName){ _initFileNameMC = initFileName;};
  inline  void SetInitFileData(TString initFileName){ _initFileNameData = initFileName;};
  ...
  inline  float GetRescaledWidth(float width, float peakShift){ return width/(91.187+peakShift);}
